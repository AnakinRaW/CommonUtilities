...
//public class ReadOnlyValueListDictionary_Keys : ICollectionTestSuite<string>
//{
...
//    {
//        return new ReadOnlyValueListDictionary<string, string>(new ValueListDictionary<string, string>()).Keys;
//    }
...
//                list.Add(key, CreateT(seed++));
//        }
//        return new ReadOnlyValueListDictionary<string, string>(list).Keys;
//    }
...
//        using var _ = new ReadOnlyValueListDictionary<string, string>(dictionary).Keys.GetEnumerator();
//    }
//}