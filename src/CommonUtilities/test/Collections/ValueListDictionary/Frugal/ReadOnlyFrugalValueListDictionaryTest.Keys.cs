...
public class ReadOnlyFrugalValueListDictionary_Keys : ValueListDictionary_Keys_TestSuite
{
    ...
    [Fact]
    public void ReadOnlyFrugalValueListDictionary_KeyCollection_Constructor_NullDictionary()
    {
        Assert.Throws<ArgumentNullException>(() => new ReadOnlyFrugalValueListDictionary<string, string>.KeyCollection(null!));
    }
}