...
public class FrugalValueListDictionaryTest_int_int : FrugalValueListDictionaryTestBase<int, int>
{
...
public class FrugalValueListDictionaryTest_string_string : FrugalValueListDictionaryTestBase<string, string>
{
