...
public static partial class EncodingExtensions
{
    ...
    extension(Encoding encoding)
    {
        ...
        public string EncodeString(string value, int maxByteCount)
        {
            if (value == null)
                throw new ArgumentNullException(nameof(value));
        ...
        public string EncodeString(ReadOnlySpan<char> value)
        {
            if (encoding == null)
        ...
        /// <exception cref="ArgumentException"><paramref name="maxByteCount"/> is less than actually required.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="maxByteCount"/> is negative.</exception>
        public unsafe string EncodeString(ReadOnlySpan<char> value, int maxByteCount)
        {
            if (encoding == null)
                throw new ArgumentNullException(nameof(encoding));
            if (maxByteCount < 0)
        ...
        public int EncodeString(ReadOnlySpan<char> source, Span<char> destination)
        {
            if (encoding == null)
                throw new ArgumentNullException(nameof(encoding));
        ...
        /// <exception cref="ArgumentException"><paramref name="maxByteCount"/> is less than actually required.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="maxByteCount"/> is negative.</exception>
        public unsafe int EncodeString(ReadOnlySpan<char> source, Span<char> destination, int maxByteCount)
        {
            if (encoding == null)
                throw new ArgumentNullException(nameof(encoding));
            if (maxByteCount < 0)
        ...
        public ReadOnlySpan<byte> GetBytesReadOnly(ReadOnlySpan<char> value, Span<byte> inputBuffer)
        {
